...
public partial class CoreModel : MinObservableObject
{
    ...
    public async Task<CoreModel> RefreshAllDataAsync(CancellationToken cancellationToken = default)
    {
        ...
        var maxTempTask = _nuclearesWeb.LoadDataFromGameAsync("CORE_TEMP_MAX", cancellationToken);
        var minTempTask = _nuclearesWeb.LoadDataFromGameAsync("CORE_TEMP_MIN", cancellationToken);
        var isResidualTask = _nuclearesWeb.LoadDataFromGameAsync(
            "CORE_TEMP_RESIDUAL",
            cancellationToken
        );
        var pressureTask = _nuclearesWeb.LoadDataFromGameAsync("CORE_PRESSURE", cancellationToken);
        ...
        var wearTask = _nuclearesWeb.LoadDataFromGameAsync("CORE_WEAR", cancellationToken);
        var stateTask = _nuclearesWeb.LoadDataFromGameAsync("CORE_STATE", cancellationToken);
